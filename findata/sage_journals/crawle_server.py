...
class SageJournals:
    def __init__(self):
        self.url = 'https://sage.figshare.com/api/graphql?thirdPartyCookies=true&type=current&operation=search'
        self.data = {
            ...
            "variables":
                    {
                         ...
                         "filters": {"institutionId": 342,
                         "facets": {
                             "contentTypes": ["item", "collection"]
                         }
                    },
                    "cursor": "",
                    "pageSize": 40
